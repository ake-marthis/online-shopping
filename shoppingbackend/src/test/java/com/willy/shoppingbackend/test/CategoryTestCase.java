package com.willy.shoppingbackend.test;
...
public class CategoryTestCase {
	...
	public static void init() {
		...
		context.scan("com.willy.shoppingbackend");
		context.refresh();
	...
	public void testAddCategory() {
		...
		category.setDescription("Description de Mobile");
	...
	*/
	...
	public void testCRUDCategory() {
		...
		category.setName("Destop");
		category.setDescription("This is some description for Destop!");
